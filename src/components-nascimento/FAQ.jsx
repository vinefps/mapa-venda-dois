...
const FAQ = ({ theme = { primaryColor: "#8B5CF6", secondaryColor: "#A78BFA" } }) => {
  ...
  // Lista de perguntas frequentes sobre o Mapa de Nascimento
  const faqs = [
    {
      question: "O que é um Mapa de Nascimento Numerológico?",
      answer: "Um Mapa de Nascimento Numerológico é uma análise detalhada baseada nos números derivados do seu nome completo e data de nascimento. Ele revela aspectos profundos da sua personalidade, desafios, talentos e propósito de vida através de sete números principais: Motivação, Impressão, Expressão, Dia Natalício, Destino, Missão e Desafios."
    },
    {
      question: "Como é feito o Mapa de Nascimento?",
      answer: "O Mapa é elaborado através de cálculos precisos baseados na Numerologia Cabalística. Convertemos as letras do seu nome em números e realizamos cálculos específicos com sua data de nascimento. Cada número resultante é analisado individualmente e em relação aos demais, criando um panorama completo da sua essência numerológica."
    },
    {
      question: "Quais informações preciso fornecer?",
      answer: "Você precisará fornecer seu nome completo de nascimento (exatamente como consta na certidão) e sua data de nascimento completa (dia, mês e ano). É importante que essas informações estejam corretas para garantir a precisão do seu mapa."
    },
    {
      question: "Quanto tempo demora para receber meu mapa?",
      answer: "Você receberá seu Mapa de Nascimento Numerológico em até 24 horas após a confirmação do pagamento. Em períodos de grande demanda, esse prazo pode se estender para até 48 horas, mas você será informado caso isso ocorra."
    },
    {
      question: "Como receberei meu mapa?",
      answer: "Seu mapa será enviado em formato PDF para o e-mail cadastrado na compra. O documento é detalhado, contém todas as análises e pode ser salvo ou impresso para consultas futuras. Não há consulta ou devolutiva personalizada incluída no valor, apenas o documento PDF com todas as informações necessárias para seu autoconhecimento."
    },
    {
      question: "O mapa é realmente personalizado?",
      answer: "Sim, cada Mapa de Nascimento é completamente personalizado e único. Ele é calculado especificamente com base nos seus dados, resultando em uma análise exclusiva que reflete sua essência individual e seu caminho de vida particular."
    },
    {
      question: "Haverá alguma consulta ou devolutiva ao vivo incluída?",
      answer: "Não, o produto consiste exclusivamente no arquivo PDF do Mapa de Nascimento. O documento foi desenvolvido para ser autoexplicativo e completo, contendo todas as informações necessárias para seu autoconhecimento. Não há sessões de devolutiva, consultas ao vivo ou acompanhamento posterior incluídos neste valor."
    },
    {
      question: "O que o mapa inclui exatamente?",
      answer: "Seu mapa inclui a análise completa dos sete números principais: Motivação (suas motivações internas), Impressão (como os outros o percebem), Expressão (como você se comunica), Dia Natalício (suas ferramentas naturais), Destino (seu caminho de vida), Missão (seu propósito) e Desafios (obstáculos a superar). Cada número é explicado detalhadamente, junto com suas implicações práticas."
    },
    {
    ...
    },
    {
      ...
      answer: "Não, seu mapa é elaborado com linguagem clara e acessível, mesmo para quem nunca teve contato com numerologia. Todas as interpretações são apresentadas de forma prática e aplicável à sua vida cotidiana."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`faq-header text-center max-w-3xl mx-auto mb-16 ${isVisible ? 'is-visible' : ''}`}>
          ...
          <p className="faq-description text-xl text-gray-600">
            Esclarecemos as dúvidas mais comuns sobre o Mapa de Nascimento Numerológico e como ele pode transformar sua vida
          </p>
        </div>

        {/* Destaque para informação de entrega */}
        <div className={`max-w-3xl mx-auto bg-purple-50 p-5 rounded-xl mb-10 border border-purple-100 ${isVisible ? 'is-visible' : ''}`} style={{ transitionDelay: '200ms' }}>
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div>
              ...
              <p className="text-purple-800">
                O Mapa de Nascimento é entregue exclusivamente em formato PDF. Não há consultas ou devolutivas ao vivo incluídas neste valor. O documento PDF contém toda a análise completa necessária para seu autoconhecimento.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`faq-contact text-center mt-16 text-gray-600 ${isVisible ? 'is-visible' : ''}`}>
          ...
          <a
            href="mailto:viniciusosilva822@gmail.com"
