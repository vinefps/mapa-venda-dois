...
const Pricing = ({ theme = { primaryColor: "#2E8B57", secondaryColor: "#3CB371", accentColor: "#20B2AA" } }) => {
  ...
  const productFeatures = [
    "Mapeamento de Bloqueios Financeiros",
    "Ciclos Financeiros Pessoais",
    "Estratégias de Abundância",
    "Números da Fortuna",
    "Vibrações Favoráveis à Prosperidade",
    "Técnicas de Ativação Energética",
    "Padrões Limitantes"
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 z-10 relative">
        ...
        <div className={`text-center mb-8 md:mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-gray-900">
            Descubra Sua Energia Financeira
          </h2>

          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Um investimento único que transformará sua relação com o dinheiro e desbloqueará seu potencial de prosperidade
          </p>
        </div>
        ...
        <div className={`max-w-4xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-xl md:rounded-2xl shadow-xl overflow-hidden border border-gray-100 pricing-card">
              {/* Cabeçalho do card */}
              <div className="p-4 md:p-10 bg-gradient-to-r from-green-50 to-green-100 border-b border-gray-200">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <div>
                    <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-2">
                      Mapa da Energia Financeira Completo
                    </h3>
                    <p className="text-gray-600 text-sm md:text-base">
                      Sua análise numerológica financeira detalhada baseada em numerologia cabalística
                    </p>
                  </div>
              ...
              <div className="p-4 md:p-10">
                ...
                <div className="space-y-3 md:space-y-4 mb-6 md:mb-10">
                  {[
                    {
                      title: "Mapeamento de Bloqueios Financeiros",
                      description: "Identificamos os padrões energéticos que estão limitando seu progresso financeiro."
                    },
                    {
                      title: "Ciclos Financeiros Pessoais",
                      description: "Revelamos seus períodos de maior prosperidade para decisões financeiras estratégicas."
                    },
                    {
                      title: "Estratégias de Abundância",
                      description: "Técnicas personalizadas baseadas na sua vibração numérica para manifestar prosperidade."
                    },
                    {
                      title: "Números da Fortuna",
                      description: "Descubra seus números mais favoráveis para investimentos e decisões financeiras."
                    },
                    {
                      title: "Vibrações Favoráveis à Prosperidade",
                      description: "Identifique as energias que potencializam seu sucesso financeiro."
                    },
                    {
                      title: "Técnicas de Ativação Energética",
                      description: "Práticas diárias para alinhar sua energia com a frequência da abundância."
                    },
                    {
                      title: "Padrões Limitantes",
                      description: "Reconheça e transforme crenças negativas sobre dinheiro que sabotam sua prosperidade."
                    }
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                <div className="bg-green-50 p-4 md:p-5 rounded-lg md:rounded-xl mb-5 md:mb-6 border border-green-100">
                  <div className="flex flex-col md:flex-row items-start gap-3 md:gap-4">
                    <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-green-100 flex items-center justify-center mx-auto md:mx-0">
                ...
                <div className="text-center mb-6 md:mb-8">
                  <div className="inline-block bg-green-50 border border-green-100 rounded-full px-4 md:px-6 py-1 mb-3 md:mb-4">
                    <p className="text-green-600 font-bold text-sm md:text-base">Oferta Especial!</p>
                  </div>

                  <div className="bg-green-100 p-3 md:p-4 rounded-lg md:rounded-xl mb-4">
                    <p className="text-green-800 font-medium text-xs md:text-sm">
                      Seu mapa completo inclui todas as 7 análises essenciais para transformar sua relação com o dinheiro, por um único investimento.
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center mb-6 md:mb-8">
                  ...
                  >
                    ...
                    <span className="relative flex items-center justify-center text-sm md:text-base" style={{ zIndex: 10 }}>
                      RECEBER MEU MAPA DA ENERGIA FINANCEIRA EM PDF
                    </span>
                  </a>
